        ...
        <div id="tarefa" v-cloak="">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="titulo" class="form-control" id="titulo" placeholder="Titulo" v-model="tarefaConsulta.titulo">
                    </div>
                </div>
                <div class="form-group">
                    <label for="texto" class="col-sm-2 control-label">Texto</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="texto" name="texto" placeholder="Texto" v-model="tarefaConsulta.texto">
                    </div>
                </div>
                <div class="form-group">
                    <label for="usuarioAbertura" class="col-sm-2 control-label">Usuario Abertura</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="usuarioAbertura" name="usuarioAbertura" placeholder="Usuario Abertura" v-model="tarefaConsulta.usuarioAbertura">
                    </div>
                </div>
                <div class="form-group">
                    <label for="usuarioResponsavel" class="col-sm-2 control-label">Usuario Responsável</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="usuarioResponsavel" name="usuarioResponsavel" placeholder="Usuario Responsável" v-model="tarefaConsulta.usuarioResponsavel">
                    </div>
                </div>
                <div class="form-group">
                    <label for="tipoTarefa" class="col-sm-2 control-label">Tipo Tarefa</label>
                    <div class="col-sm-10">
                        <g:select name="tipoTarefa" class="form-control" v-model="tarefaConsulta.tipoTarefa" noSelection="['':'-- Selecione --']"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <g:select name="statusTarefa" class="form-control" v-model="tarefaConsulta.statusTarefa" noSelection="['':'-- Selecione --']"
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="tarefa in tarefas" :key="tarefa.id">
                                        ...
                                        <td>
                                            <button class="btn btn-success pull-right" @click="modalTarefa(tarefa)">
                                                Log
                                            </button>
                                         </td>
                                    </tr>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" @click="salvarLogTarefa"><i class="fa fa-floppy-o"></i> Salvar</button>
              ...
              <div class="modal fade" tabindex="-1" role="dialog" id="formModalTarefa">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
