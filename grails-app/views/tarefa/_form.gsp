...
<div class="form-group">
    ...
    <div class="col-sm-10">
            ...
            <g:hiddenField name="usuarioAberturaHidden" v-model="tarefa.usuarioAbetura" />
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <g:select name="porcentagem" from="${0..100}" class="form-control" v-model="tarefa.porcentagem" readonly="{{somenteLeitura}}" />
    </div>
</div>